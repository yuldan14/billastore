...
<body>
  ...
  <section id="hero">
    <div class="hero">
      <div class="text">
        <h2 style="color:white;">Welcome to Billastore</h2>
        <h5 style="color:white;">Menyediakan baju busana muslim terbaik.</h5>
  ...
  <section id="kategori">
    ...
    <div class="container">
      <div class="produk" id="p-pria">
        <div class="text">
          <h3>Pakaian Pria</h3>
          <div class="button">
            <a href="product.php">Beli Sekarang</a>
          </div>
        </div>
        <!-- <div class="foto">
  ...
  <!-- <section id="latest">
    ...
    <div class="produk-container">
      <div class="product">
        ...
        <div class="nama">Kaos Billastore</div>
  ...
  <footer>
    <div class="contact" id="foot">
      <h3>Kontak Kami</h3>
      <p id="text">Billastore Official Store</p>
